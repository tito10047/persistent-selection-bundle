...
{
    private function createControllerWithManager(string $id, SelectionManagerInterface $manager): SelectController
    {
    ...
    public function testRowSelectorToggleSelectsWhenSelectedTrue(): void
    {
        ...
        $controller = $this->createControllerWithManager($managerId, $manager);
    ...
    {
        $controller = $this->createControllerWithManager('any', $this->createMock(SelectionManagerInterface::class));
